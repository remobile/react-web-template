...
module.exports = React.createClass({
    ...
    cropImage () {
        return new Promise((resovle) => {
            const { source, editRectWidth, editRectHeight, imageWidth, imageHeight } = this.props;
            ...
            this.canvas.width = editRectWidth;
            this.canvas.height = editRectHeight;
            img.onload = () => {
                ctx.drawImage(img, x * ratioX, y * ratioY, width * ratioX, height * ratioY, 0, 0, editRectWidth, editRectHeight);
                resovle(this.canvas.toDataURL('image/png'));
            };
            img.src = source.uri;
        });
    },
